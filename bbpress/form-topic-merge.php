...
<div class="naslov text-center" style="background: <?php echo get_field('color', bbp_get_topic_forum_id()) ?>;">
    <div class="container">
        ...
        <h1><?php printf( __( 'Merge topic "%s"', 'bbpress' ), bbp_get_topic_title() ); ?></h1>
    </div>
</div>
<div class="container">
    ...
    <?php if ( is_user_logged_in() && current_user_can( 'edit_topic', bbp_get_topic_id() ) ) : ?>
        ...
        <div id="merge-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-merge">
            ...
            <form id="merge_topic" name="merge_topic" method="post" action="<?php the_permalink(); ?>" class="odgovori_forma">
                ...
                <div class="naslovi">
                    <h3 class="text-uppercase"><?php _e( 'Destination', 'bbpress' ); ?></h3><hr>
                </div>
