            ...
            <div class="lista_kategorija">
                ...
                <ul class="list-unstyled">
                    ...
                    if (have_posts()) : while (have_posts()) : the_post(); ?>
                        <li <?php if( $this_post == $post->ID ) { echo ' class="active"'; } ?>><a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><span class="kocka" style="background: <?php echo get_field("color"); ?>"></span> <?php the_title(); ?></a> <span class="pull-right badge"> <?php echo bbp_get_forum_topic_count(get_the_ID()) ?></span></li>
                    <?php endwhile; ?>
                    <?php endif; ?>
                    <?php wp_reset_query(); ?>
                </ul>
                    ...
                    <div class="izaberi">
                        <div class="btn-group hidden-md hidden-lg" role="group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php query_posts(array('post_type' => bbp_get_forum_post_type(), 'orderby' => 'menu_order', 'order' => 'asc', 'posts_per_page' => '99', 'post_parent' => 0));
                                if (have_posts()) : while (have_posts()) : the_post(); ?>
                                    <li <?php if( $this_post == $post->ID ) { echo ' class="active"'; } ?>><a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><span class="kocka" style="background: <?php echo get_field("color"); ?>"></span> <?php the_title(); ?></a></li>
                                <?php endwhile; ?>
                                <?php endif; ?>
                                <?php wp_reset_query(); ?>
                            </ul>
