            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="avatar pull-left">
                        <?php bbp_reply_author_link( array( 'post_id' => bbp_get_topic_last_active_id(), 'type' => 'avatar', 'size' => 50 ) ); ?>
                        <span class="status">
<?php do_action( 'bbp_theme_before_topic_title' ); ?>
                    ...
                    <div class="pull-right hidden-xs">
                        <?php if ( !bbp_is_single_forum() || ( bbp_get_topic_forum_id() !== bbp_get_forum_id() ) ) : ?>
                            ...
                            <a data-toggle="tooltip" data-placement="top" title="<?php echo _x( 'Category', 'Forum is a category', 'bbpress' ) ?>" href="<?php echo bbp_get_forum_permalink( bbp_get_reply_forum_id() ) ?>" class="kategorija" style="background: <?php echo get_field('color', bbp_get_reply_forum_id()) ?>;"><?php echo bbp_get_forum_title( bbp_get_reply_forum_id() ) ?></a>
...
<i class="fa fa-reply" aria-hidden="true"></i>
    <?php bbp_reply_author_link( array( 'post_id' => bbp_get_topic_last_active_id(), 'type' => 'name') ); ?>
</span>
                            <span class="vrijeme">
