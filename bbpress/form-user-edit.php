...
<form id="bbp-your-profile" action="<?php bbp_user_profile_edit_url( bbp_get_displayed_user_id() ); ?>" method="post" enctype="multipart/form-data">
	...
	<div class="naslovi">
		<h3 class="text-uppercase"><?php _e( 'Name', 'bbpress' ) ?></h3><hr>
	</div>
	...
	<div class="naslovi">
		<h3 class="text-uppercase"><?php _e( 'Contact Info', 'bbpress' ) ?></h3><hr>
	</div>
	...
	<div class="naslovi">
		<h3 class="text-uppercase"><?php bbp_is_user_home_edit() ? _e( 'About Yourself', 'bbpress' ) : _e( 'About the user', 'bbpress' ); ?></h3><hr>
	</div>
	...
	<fieldset class="bbp-form">
		...
		<div class="form-group">
			<?php _e( 'Biographical Info', 'bbpress' ); ?>
	...
	<div class="naslovi">
		<h3 class="text-uppercase"><?php _e( 'Account', 'bbpress' ) ?></h3><hr>
	</div>
	...
	<?php if ( current_user_can( 'edit_users' ) && ! bbp_is_user_home_edit() ) : ?>
		...
		<div class="naslovi">
			<h3 class="text-uppercase"><?php _e( 'User Role', 'bbpress' ) ?></h3><hr>
		</div>
	...
	<fieldset class="submit">
		...
		<div class="form-group text-right">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_user_edit_submit" name="bbp_user_edit_submit" class="btn btn-success"><?php bbp_is_user_home_edit() ? _e( 'Update Profile', 'bbpress' ) : _e( 'Update User', 'bbpress' ); ?></button>
		</div>
	</fieldset>
